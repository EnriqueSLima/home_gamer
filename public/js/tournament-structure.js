  ...
  const addLevel = () => {
    ...
    newLevel.innerHTML = `
        <label for="level${index}" class="form-label">Level ${index}</label>
          <input type="number" name="levels[${index}][duration]" class="form-input time">
          <input type="number" step="25" name="levels[${index}][small_blind]" class="form-input small_blind">
          <input type="number" step="25" name="levels[${index}][big_blind]" class="form-input big_blind">
      `;
